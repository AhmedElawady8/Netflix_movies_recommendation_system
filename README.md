...
using Machine Learning (Cosine Similarity) with a beautiful Netflix-themed

Streamlit UI. The app fetches live movie data from the TMDB API and displays

posters, ratings, genres, and plot overviews for each recommendation.
...
\[👉 Open the App on Streamlit](YOUR\_STREAMLIT\_LINK\_HERE)
...
git clone https://github.com/AhmedElawady8/Netflix\_movies\_recommendation\_system.git

cd Netflix\_movies\_recommendation\_system
